...
import type { AdaptiveTuiMode } from "@gsd/pi-coding-agent/core/settings-manager.js";
import {
	Container,
	getCapabilities,
	type SelectItem,
...
import { getSelectListTheme, getSettingsListTheme, theme } from "@gsd/pi-coding-agent/theme/theme.js";
...
export const THINKING_DESCRIPTIONS: Record<ThinkingLevel, string> = {
	...
	max: "Maximum model-specific reasoning",
};

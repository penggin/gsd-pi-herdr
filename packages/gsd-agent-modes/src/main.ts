...
import { APP_NAME, getAgentDir, getModelsPath, VERSION } from "@gsd/pi-coding-agent/config.js";
import { AuthStorage } from "@gsd/pi-coding-agent/core/auth-storage.js";
import { exportFromFile } from "@gsd/agent-core";
import type { LoadExtensionsResult } from "@gsd/pi-coding-agent/core/extensions/index.js";
import { KeybindingsManager } from "@gsd/agent-core";
import { ModelRegistry } from "@gsd/pi-coding-agent/core/model-registry.js";
import { isLocalModel } from "@gsd/pi-coding-agent/core/local-model-check.js";
import { resolveCliModel, resolveModelScope, type ScopedModel } from "@gsd/pi-coding-agent/core/model-resolver.js";
import { runPackageCommand } from "@gsd/pi-coding-agent/core/package-commands.js";
import { DefaultPackageManager } from "@gsd/pi-coding-agent/core/package-manager.js";
import { DefaultResourceLoader } from "@gsd/pi-coding-agent/core/resource-loader.js";
import { type CreateAgentSessionOptions, createAgentSession } from "@gsd/agent-core";
...
export async function main(args: string[]) {
	...
	if (parsed.addProvider) {
		const { ModelsJsonWriter } = await import("@gsd/pi-coding-agent/core/models-json-writer.js");

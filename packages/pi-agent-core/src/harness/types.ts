import type { ImageContent, Model, SimpleStreamOptions, TextContent, Transport } from "@gsd/pi-ai";
...
export interface FileSystem {
	...
	/** Atomically rename a file, replacing the destination when supported by the platform. */
